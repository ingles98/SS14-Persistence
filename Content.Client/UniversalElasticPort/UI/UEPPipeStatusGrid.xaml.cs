...
public sealed partial class UEPPipeStatusGrid : GridContainer
{

    public UEPPipeStatusGrid(UEPBoundUserInterface bui, UEPPipePlugState plug, UEPPlugCard parent)
    {
